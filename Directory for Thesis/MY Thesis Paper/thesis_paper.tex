...
\begin{figure}[h]
    ...
    \caption{Language distribution of complaints showing 48.8\% in English, 14.8\% in Bengali (বাংলা), and 36.3\% in Banglish (mixed language). The chart demonstrates the multilingual nature of citizen complaints, requiring comprehensive language support.}
