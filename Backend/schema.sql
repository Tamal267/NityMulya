...
CREATE TABLE IF NOT EXISTS chat_messages (
    ...
    sender_type VARCHAR(20) NOT NULL CHECK (sender_type IN ('wholesaler', 'shop_owner')),
    receiver_type VARCHAR(20) NOT NULL CHECK (receiver_type IN ('wholesaler', 'shop_owner')),
