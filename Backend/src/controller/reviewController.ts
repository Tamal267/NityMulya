...
export class ReviewController {
  ...
  // Additional methods that might be called by the routes
  async getShopAverageRating(c: Context) {
    return c.json({ 
      success: true, 
      message: 'Shop average rating not implemented in memory version',
      ratings: { overall: 0, delivery: 0, service: 0 }
    });
  }
  ...
  async getReviewStats(c: Context) {
    return c.json({ 
      success: true, 
      message: 'Review stats not implemented in memory version',
      stats: {}
    });
  }
  ...
  async markReviewHelpful(c: Context) {
    return c.json({ 
      success: true, 
      message: 'Mark helpful not implemented in memory version'
    });
  }
  ...
  async deleteReview(c: Context) {
    return c.json({ 
      success: true, 
      message: 'Delete review not implemented in memory version'
    });
  }
}
