...
(
    ...
    NULL,
    (SELECT id FROM subcategories WHERE subcat_name = 'চাল' LIMIT 1),
    5,
...
(
    ...
    (SELECT id FROM shop_owners OFFSET 1 LIMIT 1),
    NULL,
    (SELECT id FROM subcategories WHERE subcat_name = 'চাল' LIMIT 1),
    5,
...
(
    ...
    (SELECT id FROM shop_owners LIMIT 1),
    NULL,
    (SELECT id FROM subcategories WHERE subcat_name = 'ডাল' LIMIT 1),
    4,
...
(
    ...
    (SELECT id FROM shop_owners OFFSET 1 LIMIT 1),
    NULL,
    (SELECT id FROM subcategories WHERE subcat_name = 'তেল' LIMIT 1),
    5,
